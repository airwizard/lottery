  ...
  >
    <!--<nav class="grid grid-flow-col gap-4">
      <a
        ...
        target="_blank"
        href="https://1kw20.fun"
        >{{ t("footer.self-reflection") }}</a
      >
    </nav>
    <nav>
      <a
    ...
    <nav>
      <div class="grid grid-flow-col gap-4">
        <a
          href="https://github.com/airwizard/"
          target="_blank"
          class="cursor-pointer text-inherit"
        >
          <svg-icon name="github" />
        </a>
        <a href="https://x.com/willdwang" target="_blank" class="cursor-pointer"
          ><svg-icon name="twitter"
        /></a>
        <a
          href="https://www.instagram.com/willdwang/"
          target="_blank"
    ...
    <aside>
      <!--<p class="p-0 m-0">
        Powered by William D. Wang
      </p>-->
      <p>Copyright © 2025 - All rights reserved by William D. Wang</p>
    </aside>
  </footer>
</template>
